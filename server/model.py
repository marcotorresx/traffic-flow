...
class RandomModel(Model):
    ...
    def __init__(self):
        ...
        with open('./map_templates/map.txt') as baseFile:
    ...
    def spawn_cars(self):
        ...
        for cell in self.spawn_cars_cells:
            ...
            if self.random.random() < 0.6:
                destination_index = self.random.randint(0, len(self.destinations) - 1)
                destination = self.destinations[destination_index] # Random destination
                ...
                if available:
                    car = Car(f"c_{self.cars_counter}", self, destination, destination_index)
